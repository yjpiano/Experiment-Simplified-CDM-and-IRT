...
Based on the true values (learner skill mastery
...
parameters, 20 sets of response data matrices were created using the
DINA model described below. Each response data matrix was for 200
learners and 30 items. <br>

The function of a correct item response under DINA is described as
follows:  

![P\_{ij} = h\_{j}^{\eta\_{ij}}g\_{j}^{(1 - \eta\_{ij})}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;P_%7Bij%7D%20%3D%20h_%7Bj%7D%5E%7B%5Ceta_%7Bij%7D%7Dg_%7Bj%7D%5E%7B%281%20-%20%5Ceta_%7Bij%7D%29%7D "P_{ij} = h_{j}^{\eta_{ij}}g_{j}^{(1 - \eta_{ij})}")

![\eta\_{ij} = \prod\_{k = 1}^{K} \alpha\_{ik}^{q\_{jk}}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Ceta_%7Bij%7D%20%3D%20%5Cprod_%7Bk%20%3D%201%7D%5E%7BK%7D%20%5Calpha_%7Bik%7D%5E%7Bq_%7Bjk%7D%7D "\eta_{ij} = \prod_{k = 1}^{K} \alpha_{ik}^{q_{jk}}")

![\alpha\_{ik}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Calpha_%7Bik%7D "\alpha_{ik}"):
learner skill mastery per skill
![k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;k "k")
by each learner
![i](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;i "i")  
![h\_{j}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;h_%7Bj%7D "h_{j}"):
1 - slip per item
![j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;j "j")  
![g\_{j}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;g_%7Bj%7D "g_{j}"):
guess per item
![j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;j "j")  
<br>
...
![P\_{ij} = \prod\_{k = 1}^{K} (h\_{k}^{\alpha\_{ik}}g\_{k}^{(1 - \alpha\_{ik})})^{q\_{jk}}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;P_%7Bij%7D%20%3D%20%5Cprod_%7Bk%20%3D%201%7D%5E%7BK%7D%20%28h_%7Bk%7D%5E%7B%5Calpha_%7Bik%7D%7Dg_%7Bk%7D%5E%7B%281%20-%20%5Calpha_%7Bik%7D%29%7D%29%5E%7Bq_%7Bjk%7D%7D "P_{ij} = \prod_{k = 1}^{K} (h_{k}^{\alpha_{ik}}g_{k}^{(1 - \alpha_{ik})})^{q_{jk}}")
...
by each learner
![i](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;i "i")  
![h\_{k}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;h_%7Bk%7D "h_{k}"):
1 - slip per skill
![k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;k "k")  
![g\_{k}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;g_%7Bk%7D "g_{k}"):
guess per skill
![k](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;k "k")  
<br>
...
![P\_{ij} = \frac{exp(\theta\_{i} - \beta\_{j})}{1 + exp(\theta\_{i} - \beta\_{j})}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;P_%7Bij%7D%20%3D%20%5Cfrac%7Bexp%28%5Ctheta_%7Bi%7D%20-%20%5Cbeta_%7Bj%7D%29%7D%7B1%20%2B%20exp%28%5Ctheta_%7Bi%7D%20-%20%5Cbeta_%7Bj%7D%29%7D "P_{ij} = \frac{exp(\theta_{i} - \beta_{j})}{1 + exp(\theta_{i} - \beta_{j})}")

![\theta\_{i}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Ctheta_%7Bi%7D "\theta_{i}"):
learner skill
![i](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;i "i")  
![\beta\_{j}](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Cbeta_%7Bj%7D "\beta_{j}"):
item difficulty
![j](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;j "j")
...
and guess
![g](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;g "g")
values that were used for simulating the DINA response data. **We found
that the Rasch item difficulty estimates from the DINA simulated data
were negatively correlated with the item hit
![h](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;h "h")
parameters
(![\rho](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Crho "\rho")
= -0.41), but the relationship with the item guess
![g](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;g "g")
parameters was weak
(![\rho](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Crho "\rho")
= -0.1).** <br>
...
<br> We compared the Rasch skill estimates with the true skill
![\alpha](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;%5Calpha "\alpha")
values that were used for simulating the NIDA response data. **The NIDA
skill mastery patterns that included Skill 5 (with the lowest hit
![h](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;h "h")
...
mastery patterns that included Skill 1 (with the highest hit
![h](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;h "h")
...
parameters and the CDM hit
![h](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;h "h")
parameters (see Sections 3.1 and 3.2). However, it was not clear or easy
to find any relationships between the Rasch parameters and the guess
![g](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;g "g")
parameters from both the DINA (item level) and NIDA (skill level)
models. To explore further, we can fit either 2PL or 3PL IRT models to
the simulated response data and compare the item discrimination
parameters with the CDM guess parameters.
